...
sequenceDiagram
    ...
    participant Sess as LightBatisSession
...
This is where the measured difference lives. For **every column of every row**, MyBatis
does:
...
| `ps.setLong(1, 42)` | Binding the value — that is the point |
...
Stated as bluntly as the design document states it: **LightBatis is an investment for
